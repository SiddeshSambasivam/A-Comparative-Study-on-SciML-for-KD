...
def main():
    ...
    st.write(
        "## A Comparative Study of Machine Learning Algorithms for Knowledge Discovery"
    )
    st.write(
        "Given a dataset $(x,y)$, $x$ is a set of input variables, and $y$ is a set of output variables, the aim of symbolic regression is to identify a function $f : x \Rightarrow y$ that **best fits the dataset.**"
    )
